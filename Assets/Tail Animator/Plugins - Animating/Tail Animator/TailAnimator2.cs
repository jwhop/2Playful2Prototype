...
namespace FIMSpace.FTail
{
    ...
    public partial class TailAnimator2 : MonoBehaviour
    {
        ...
        //public IAnimalStateManager animalStateManager;
        ...
        void Start()
        {
            //animalStateManager = GetComponent<IAnimalStateManager>();
        ...
        {
            foreach(TailSegment child in TailSegments)
            {
                child.transform.rotation = child.TrueTargetRotation;
            }
        }
